...
<html lang="en">
    <head>
        ...
        <title>Meharry Hospital Serivces - X-Ray</title>
        <!-- Favicon-->
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="display-5 fw-bolder">X-Ray Services</h1>
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through">ZMW 200.00</span>
                            <!-- <span>$40.00</span> -->
                        </div>
                        <p class="lead"> Provide effective quality X-Ray services close to the family as possible. This ensures equity of access to health service delivery and contributes to the human and socioeconomic development. </p>
                        <div class="d-flex">
                          
                        <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{url('/')}}">Back to Home</a></div>
                        </div>
                    </div>
                </div>
            </div>
